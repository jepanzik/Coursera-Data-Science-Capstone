...
```{r ngramTrainWrite}
if(!file.exists("data/final/en_US/ngram/en_US.dataTrain.1gram.txt")){
      write.table(unigramsTrain,
                  file="data/final/en_US/ngram/en_US.dataTrain.1gram.txt", sep=",",
                  col.names=FALSE, row.names=FALSE, quote=FALSE)}

if(!file.exists("data/final/en_US/ngram/en_US.dataTrain.2gram.txt")){
      write.table(bigramsTrain,
                  file="data/final/en_US/ngram/en_US.dataTrain.2gram.txt", sep=",",
                  col.names=FALSE, row.names=FALSE, quote=FALSE)}

if(!file.exists("data/final/en_US/ngram/en_US.dataTrain.3gram.txt")){
      write.table(trigramsTrain,
                  file="data/final/en_US/ngram/en_US.dataTrain.3gram.txt", sep=",",
                  col.names=FALSE, row.names=FALSE, quote=FALSE)}

if(!file.exists("data/final/en_US/ngram/en_US.dataTrain.4gram.txt")){
      write.table(quadgramsTrain,
                  file="data/final/en_US/ngram/en_US.dataTrain.4gram.txt", sep=",",
                  col.names=FALSE, row.names=FALSE, quote=FALSE)}
...
```{r probDFWrite}
if(!file.exists("data/final/en_US/predict/en_US.dataTrain.1gram.prob.txt")){
      write.table(uniProbs,
                  file="data/final/en_US/predict/en_US.dataTrain.1gram.prob.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}

if(!file.exists("data/final/en_US/predict/en_US.dataTrain.2gram.prob.txt")){
      write.table(biProbs,
                  file="data/final/en_US/predict/en_US.dataTrain.2gram.prob.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}

if(!file.exists("data/final/en_US/predict/en_US.dataTrain.3gram.prob.txt")){
      write.table(triProbs,
                  file="data/final/en_US/predict/en_US.dataTrain.3gram.prob.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}

if(!file.exists("data/final/en_US/predict/en_US.dataTrain.4gram.prob.txt")){
      write.table(quadProbs,
                  file="data/final/en_US/predict/en_US.dataTrain.4gram.prob.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}
...
```{r freqDFWrite}
if(!file.exists("data/final/en_US/predict/en_US.dataTrain.1gram.freq.txt")){
      write.table(uniFreq,
                  file="data/final/en_US/predict/en_US.dataTrain.1gram.freq.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}

if(!file.exists("data/final/en_US/predict/en_US.dataTrain.2gram.freq.txt")){
      write.table(biFreq,
                  file="data/final/en_US/predict/en_US.dataTrain.2gram.freq.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}

if(!file.exists("data/final/en_US/predict/en_US.dataTrain.3gram.freq.txt")){
      write.table(triFreq,
                  file="data/final/en_US/predict/en_US.dataTrain.3gram.freq.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}

if(!file.exists("data/final/en_US/predict/en_US.dataTrain.4gram.freq.txt")){
      write.table(quadFreq,
                  file="data/final/en_US/predict/en_US.dataTrain.4gram.freq.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}
...
```{r freqPredictWrite}
if(!file.exists("data/final/en_US/test/en_US.freqTest.predict.txt")){
      write.table(freqTest,
                  file="data/final/en_US/test/en_US.freqTest.predict.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}
```
...
```{r probPredictWrite}
if(!file.exists("data/final/en_US/test/en_US.probTest.predict.txt")){
      write.table(probTest,
                  file="data/final/en_US/test/en_US.probTest.predict.txt",
                  sep=",", col.names=TRUE, row.names=FALSE, quote=FALSE)}
```
